...
class InventoryExitsPdfGenerator {
  ...
  static Future<Uint8List> _buildPdf({
    ...
    double totalGeneralCost = exits.fold(0.0, (sum, exit) => sum + exit.totalCost);
            ...
            children: [
              pw.Column(
                ...
                children: [
                  ...
                  pw.Text(dateText, style: const pw.TextStyle(fontSize: 10)),
                  pw.SizedBox(height: 2),
                  pw.Text('Generado: $generatedAt', style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey700)),
                ],
              ),
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    pw.Text('Costo Total Perdido', style: pw.TextStyle(fontSize: 9, fontWeight: pw.FontWeight.bold, color: PdfColors.red900)),
                    pw.Text(_currencyFormat.format(totalGeneralCost), style: pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold, color: PdfColors.red900)),
                  ],
                ),
              ),
            ],
          ...
          pw.Table(
            ...
            children: [
              ...
              pw.TableRow(
                ...
                children: [
                  'Fecha', 'Motivo', 'Almacén', 'Notas', 'Ítems', 'Costo Total'
                ].map((text) => pw.Padding(
                ...
                return pw.TableRow(
                  children: [
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(6),
                      child: pw.Text(
                        exit.createdAt != null ? DateFormat('dd/MM/yy HH:mm').format(exit.createdAt!.toLocal()) : '',
  ...
  static Future<void> printReport({
    ...
    await Printing.layoutPdf(
      ...
      name: 'Reporte_Salidas_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
  ...
  static Future<void> shareReport({
    ...
    await Printing.sharePdf(
      bytes: bytes,
      filename: 'Reporte_Salidas_${DateFormat('yyyyMMdd').format(DateTime.now())}.pdf',
    );
  }
}
