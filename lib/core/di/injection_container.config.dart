...
import '../../features/cart/domain/usecases/clear_cart_uc.dart' as _i596;
import '../../features/cart/domain/usecases/load_cart_uc.dart' as _i281;
...
import '../../features/catalog/domain/usecases/toggle_wishlist_usecase.dart'
    as _i839;
import '../../features/catalog/presentation/bloc/admin_catalog/admin_catalog_cubit.dart'
    as _i613;
...
import '../../features/catalog/presentation/bloc/customer_catalog/customer_catalog_cubit.dart'
    as _i991;
import '../../features/catalog/presentation/bloc/ingredients/ingredients_cubit.dart'
    as _i635;
import '../../features/catalog/presentation/bloc/product_detail/product_detail_cubit.dart'
    as _i1039;
import '../../features/catalog/presentation/bloc/product_form/product_form_cubit.dart'
    as _i73;
...
import '../../features/customers/presentation/bloc/credit_movements/customer_credit_movements_cubit.dart'
    as _i761;
import '../../features/customers/presentation/bloc/customer_credit/customer_credit_list_cubit.dart'
    as _i851;
import '../../features/customers/presentation/bloc/customer_credit/customer_credits_cubit.dart'
    as _i792;
import '../../features/customers/presentation/bloc/customer_detail/customer_detail_cubit.dart'
    as _i367;
import '../../features/customers/presentation/bloc/customer_form/customer_form_cubit.dart'
    as _i2;
import '../../features/customers/presentation/bloc/customer_locations/customer_locations_cubit.dart'
    as _i135;
import '../../features/customers/presentation/bloc/customer_wishlist/customer_wishlist_cubit.dart'
    as _i421;
import '../../features/customers/presentation/bloc/customers/customers_cubit.dart'
    as _i70;
...
import '../../features/financial/domain/usecases/transfer_funds_usecase.dart'
    as _i862;
import '../../features/financial/presentation/bloc/account_movements/account_movements_cubit.dart'
    as _i218;
import '../../features/financial/presentation/bloc/financial_accounts/financial_accounts_cubit.dart'
    as _i30;
...
import '../../features/inventory/presentation/bloc/inventory_entries/inventory_entries_cubit.dart'
    as _i138;
import '../../features/inventory/presentation/bloc/inventory_entry_form/inventory_entry_form_cubit.dart'
    as _i977;
import '../../features/inventory/presentation/bloc/inventory_exit_form/inventory_exit_form_cubit.dart'
    as _i401;
import '../../features/inventory/presentation/bloc/inventory_exits/inventory_exits_cubit.dart'
    as _i378;
import '../../features/inventory/presentation/bloc/kardex/kardex_cubit.dart'
    as _i1068;
import '../../features/inventory/presentation/bloc/warehouses/warehouses_cubit.dart'
    as _i276;
...
import '../../features/loyalty/domain/usecases/record_mini_game_uc.dart'
    as _i626;
import '../../features/loyalty/presentation/bloc/points/points_cubit.dart'
    as _i789;
import '../../features/loyalty/presentation/bloc/top_customers/loyalty_top_customers_cubit.dart'
    as _i739;
import '../../features/loyalty/presentation/bloc/wallet_cubit.dart' as _i1028;
import '../../features/main_navigation/presentation/bloc/sidebar_badge/sidebar_badge_cubit.dart'
    as _i41;
...
import '../../features/orders/domain/usecases/check_active_cash_shift_uc.dart'
    as _i864;
...
import '../../features/orders/domain/usecases/get_filtered_orders_uc.dart'
    as _i617;
import '../../features/orders/domain/usecases/get_financial_accounts_uc.dart'
    as _i747;
...
import '../../features/orders/domain/usecases/process_checkout_uc.dart'
    as _i446;
import '../../features/orders/domain/usecases/process_return_uc.dart' as _i1;
...
import '../../features/orders/domain/usecases/watch_pending_orders_count_uc.dart'
    as _i981;
...
import '../../features/orders/presentation/bloc/customer_orders/customer_orders_cubit.dart'
    as _i442;
import '../../features/orders/presentation/bloc/order_detail/order_detail_cubit.dart'
    as _i808;
import '../../features/orders/presentation/bloc/orders/orders_cubit.dart'
    as _i1051;
...
import '../../features/purchases/domain/usecases/save_supplier_credit_usecase.dart'
    as _i321;
import '../../features/purchases/domain/usecases/save_supplier_usecase.dart'
    as _i842;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i322.CartRepository>(() => _i250.CartRepositoryImpl());
    ...
    gh.factory<_i864.CheckActiveCashShiftUc>(
      () => _i864.CheckActiveCashShiftUc(gh<_i992.OrdersRepository>()),
    );
    gh.factory<_i857.GetCustomerOrdersUc>(
      () => _i857.GetCustomerOrdersUc(gh<_i992.OrdersRepository>()),
    );
    gh.factory<_i747.GetFinancialAccountsUc>(
      () => _i747.GetFinancialAccountsUc(gh<_i992.OrdersRepository>()),
    );
    ...
    gh.factory<_i359.SearchCustomersUc>(
      () => _i359.SearchCustomersUc(gh<_i992.OrdersRepository>()),
    );
    gh.factory<_i981.WatchPendingOrdersCountUc>(
      () => _i981.WatchPendingOrdersCountUc(gh<_i992.OrdersRepository>()),
    );
    ...
    gh.lazySingleton<_i1.ProcessReturnUc>(
      () => _i1.ProcessReturnUc(gh<_i992.OrdersRepository>()),
    );
    ...
    gh.lazySingleton<_i748.LoyaltyRepository>(
    ...
    gh.lazySingleton<_i596.ClearCartUseCase>(
      () => _i596.ClearCartUseCase(gh<_i322.CartRepository>()),
    );
    gh.lazySingleton<_i281.LoadCartUseCase>(
      () => _i281.LoadCartUseCase(gh<_i322.CartRepository>()),
    );
    gh.lazySingleton<_i1022.SaveCartUseCase>(
      () => _i1022.SaveCartUseCase(gh<_i322.CartRepository>()),
    );
    ...
    gh.lazySingleton<_i1019.GetCustomersUseCase>(
      () => _i1019.GetCustomersUseCase(gh<_i875.CustomersRepository>()),
    );
    gh.lazySingleton<_i1019.GetCustomerDetailUseCase>(
      () => _i1019.GetCustomerDetailUseCase(gh<_i875.CustomersRepository>()),
    );
    gh.lazySingleton<_i1019.GetGlobalStatsUseCase>(
      () => _i1019.GetGlobalStatsUseCase(gh<_i875.CustomersRepository>()),
    );
    gh.lazySingleton<_i1019.GetTopCustomersUseCase>(
      () => _i1019.GetTopCustomersUseCase(gh<_i875.CustomersRepository>()),
    );
    gh.lazySingleton<_i1019.CreateCustomerUseCase>(
      () => _i1019.CreateCustomerUseCase(gh<_i875.CustomersRepository>()),
    );
    gh.lazySingleton<_i1019.UpdateCustomerUseCase>(
      () => _i1019.UpdateCustomerUseCase(gh<_i875.CustomersRepository>()),
    );
    gh.lazySingleton<_i1019.ToggleCustomerStatusUseCase>(
      () => _i1019.ToggleCustomerStatusUseCase(gh<_i875.CustomersRepository>()),
    );
    gh.lazySingleton<_i1019.SaveCustomerFullProfileUseCase>(
      () => _i1019.SaveCustomerFullProfileUseCase(
        gh<_i875.CustomersRepository>(),
      ),
    );
    ...
    gh.lazySingleton<_i360.FetchSupplierCreditMovementsUseCase>(
      () => _i360.FetchSupplierCreditMovementsUseCase(
    ...
    gh.factory<_i1006.CheckActiveShiftUc>(
      () => _i1006.CheckActiveShiftUc(gh<_i1050.CashShiftRepository>()),
    );
    ...
    gh.lazySingleton<_i956.RegisterSupplierPaymentUseCase>(
      () => _i956.RegisterSupplierPaymentUseCase(
        gh<_i123.SupplierCreditsRepository>(),
      ),
    );
    gh.lazySingleton<_i321.SaveSupplierCreditUseCase>(
      () => _i321.SaveSupplierCreditUseCase(
        gh<_i123.SupplierCreditsRepository>(),
      ),
    );
    ...
    gh.factory<_i138.InventoryEntriesCubit>(
      () => _i138.InventoryEntriesCubit(
    ...
    gh.lazySingleton<_i749.GetCreditAccountsUseCase>(
      () => _i749.GetCreditAccountsUseCase(gh<_i4.CustomerCreditsRepository>()),
    );
    gh.lazySingleton<_i749.GetCreditAccountByCustomerUseCase>(
      () => _i749.GetCreditAccountByCustomerUseCase(
        gh<_i4.CustomerCreditsRepository>(),
      ),
    );
    gh.lazySingleton<_i749.CreateCreditAccountUseCase>(
      () =>
          _i749.CreateCreditAccountUseCase(gh<_i4.CustomerCreditsRepository>()),
    );
    gh.lazySingleton<_i749.UpdateCreditLimitUseCase>(
      () => _i749.UpdateCreditLimitUseCase(gh<_i4.CustomerCreditsRepository>()),
    );
    gh.lazySingleton<_i749.ToggleCreditStatusUseCase>(
      () =>
          _i749.ToggleCreditStatusUseCase(gh<_i4.CustomerCreditsRepository>()),
    );
    gh.lazySingleton<_i749.GetCreditMovementsUseCase>(
      () =>
          _i749.GetCreditMovementsUseCase(gh<_i4.CustomerCreditsRepository>()),
    );
    gh.lazySingleton<_i749.RegisterCreditPaymentUseCase>(
      () => _i749.RegisterCreditPaymentUseCase(
        gh<_i4.CustomerCreditsRepository>(),
      ),
    );
    ...
    gh.factory<_i635.IngredientsCubit>(
      () => _i635.IngredientsCubit(
    ...
    gh.lazySingleton<_i842.SaveSupplierUseCase>(
      () => _i842.SaveSupplierUseCase(gh<_i943.SuppliersRepository>()),
    );
    ...
    gh.factory<_i367.CustomerDetailCubit>(
      () => _i367.CustomerDetailCubit(
        gh<_i1019.GetCustomerDetailUseCase>(),
    ...
    gh.factory<_i792.CustomerCreditsCubit>(
      () => _i792.CustomerCreditsCubit(
        gh<_i749.GetCreditAccountByCustomerUseCase>(),
        gh<_i749.GetCreditMovementsUseCase>(),
    ...
    gh.factoryParam<_i1031.SupplierCreditMovementsCubit, String, String>(
      (creditId, supplierName) => _i1031.SupplierCreditMovementsCubit(
        fetchMovementsUseCase: gh<_i360.FetchSupplierCreditMovementsUseCase>(),
        generatePdfUseCase:
    ...
    gh.lazySingleton<_i380.ClaimDailyCheckinUC>(
      () => _i380.ClaimDailyCheckinUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i696.GetLatestCheckinUC>(
      () => _i696.GetLatestCheckinUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i589.GetLoyaltyProfileUC>(
      () => _i589.GetLoyaltyProfileUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i893.GetTodayCheckinUC>(
      () => _i893.GetTodayCheckinUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i231.GetTodayMiniGamesUC>(
      () => _i231.GetTodayMiniGamesUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i34.GetTopCustomersUC>(
      () => _i34.GetTopCustomersUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i631.GetWalletBalanceUC>(
      () => _i631.GetWalletBalanceUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i829.GetWalletMovementsUC>(
      () => _i829.GetWalletMovementsUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.lazySingleton<_i626.RecordMiniGameUC>(
      () => _i626.RecordMiniGameUC(gh<_i748.LoyaltyRepository>()),
    );
    gh.factory<_i14.TopCustomersCubit>(
      () => _i14.TopCustomersCubit(gh<_i1019.GetTopCustomersUseCase>()),
    );
    ...
    gh.factory<_i54.SupplierCreditsCubit>(
      () => _i54.SupplierCreditsCubit(
        ...
        registerSupplierPaymentUseCase:
            gh<_i956.RegisterSupplierPaymentUseCase>(),
      ),
    );
    ...
    gh.lazySingleton<_i712.GetAdminFinancialDataUseCase>(
      () => _i712.GetAdminFinancialDataUseCase(gh<_i570.ProductsRepository>()),
    );
    ...
    gh.factory<_i713.VerifyStockUc>(
      () => _i713.VerifyStockUc(gh<_i760.CheckoutRepository>()),
    );
    gh.factory<_i2.CustomerFormCubit>(
      () => _i2.CustomerFormCubit(
    ...
    gh.factory<_i431.SuppliersCubit>(
      () => _i431.SuppliersCubit(
        ...
        saveSupplierUseCase: gh<_i842.SaveSupplierUseCase>(),
      ),
    );
    ...
    gh.factory<_i378.InventoryExitsCubit>(
      () => _i378.InventoryExitsCubit(
    ...
    gh.factory<_i437.PosCubit>(
      () => _i437.PosCubit(
        ...
        getOrderDetails: gh<_i93.GetOrderDetailsUc>(),
        posRepository: gh<_i511.PosRepository>(),
