...
class _ProductIngredientsSectionState
    extends State<ProductIngredientsSection> {
    ...
    for (final row in rows) {
      if (!_nameControllers.containsKey(row.id)) {
        ...
        _concentrationControllers[row.id] =
            TextEditingController(text: row.concentration);
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: state.ingredientsEnabled
          ...
          AnimatedSize(
            ...
            child: state.ingredientsEnabled
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
...
class _IngredientSearchDialogState extends State<IngredientSearchDialog> {
  ...
  void _search(String term) {
    ...
    _debounce = Timer(const Duration(milliseconds: 400), () async {
      ...
      try {
        final resEither =
            await _getIngredientsUC.call(searchQuery: term.trim());
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      label: const Text('Sí, crear ingrediente',
