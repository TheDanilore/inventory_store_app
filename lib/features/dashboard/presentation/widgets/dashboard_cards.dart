...
class GananciaBrutaCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          // Sparkline en el fondo (ultra sutil)
          if (sparklineData != null && sparklineData!.isNotEmpty)
            Positioned(
              right: -20,
              bottom: 0,
              ...
              child: Opacity(
                opacity: 0.12,
                child: CustomPaint(
                  painter: _SparklinePainter(AppColors.success, sparklineData!),
                ),
              ),
            ),
          Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF0F0F1A).withValues(alpha: 0.4),
            blurRadius: 24,
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    hasReachedGoal ? '🎉 META CUMPLIDA' : 'MI META DE AHORRO',
                    style: TextStyle(
                ...
                Text(
                  hasReachedGoal
                      ? '¡Excelente trabajo!'
                      : 'Faltan S/ ${remainingAmount.toStringAsFixed(2)}',
                  style: TextStyle(
                    color:
                        hasReachedGoal
