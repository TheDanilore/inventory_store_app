      ...
      listener: (context, state) {
        switch (state.status) {
          case CheckoutStatus.stockError:
            CartStockErrorDialog.show(context, messages: state.stockMessages);
      ...
      builder: (context, cartState) {
        ...
        if (cartState.items.isEmpty) {
          return const AppEmptyState(
            ...
            message: 'Agrega productos desde el catálogo para armar tu pedido.',
          );
        }
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${cartState.items.length} productos en tu lista',
