    ...
    return BlocBuilder<CustomersStatsCubit, CustomersStatsState>(
      builder: (context, state) {
        if (state is CustomersStatsLoading) {
          // SHIMMER DE CARGA PARA LAS ESTADÍSTICAS
          return Container(
            ...
            child: Row(
              ...
              children: const [
                AppShimmer(width: 60, height: 40, borderRadius: 8),
                AppShimmer(width: 60, height: 40, borderRadius: 8),
                AppShimmer(width: 60, height: 40, borderRadius: 8),
                AppShimmer(width: 60, height: 40, borderRadius: 8),
              ],
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'No se pudieron cargar las estadísticas: ${state.message}',
                ...
                TextButton.icon(
                  onPressed: () => context.read<CustomersStatsCubit>().loadStats(),
