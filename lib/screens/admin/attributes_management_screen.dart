...
class _AttributesManagementScreenState extends State<AttributesManagementScreen> {
  ...
  void _showAddValueForm(String attributeId, String attributeName) {
    showDialog(
      context: context,
      builder: (context) => AttributeValueDialog(
                                    ...
                                    children: [
                                      ...values.map(
                                        (v) => InputChip(
                                          ...
                                          onDeleted: provider.isSaving 
                                            ? null 
                                            : () => provider.deleteAttributeValue(context, v['id'], v['value']),
