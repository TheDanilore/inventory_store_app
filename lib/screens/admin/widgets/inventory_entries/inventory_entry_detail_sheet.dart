...
class InventoryEntryDetailSheet extends StatefulWidget {
  ...
  const InventoryEntryDetailSheet({super.key, required this.entry, required this.loadItems});

  @override
  State<InventoryEntryDetailSheet> createState() => _InventoryEntryDetailSheetState();
}
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (item.usesBatches && item.expiryDate != null)
                                      Text(
