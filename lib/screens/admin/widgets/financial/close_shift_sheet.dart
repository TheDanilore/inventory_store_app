        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: _difference != null ? diffColor.withValues(alpha: 0.08) : AppColors.surface,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: _difference != null ? diffColor.withValues(alpha: 0.3) : Colors.transparent),
              ),
