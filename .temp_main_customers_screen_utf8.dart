...
class _CustomersScreenContentState extends State<_CustomersScreenContent>
  ...
  Widget _buildTabletLayout(BuildContext context, CustomersProvider provider) {
    return Row(
      ...
      children: [
        // MASTER: B├║squeda, Estad├¡sticas, Top 5 y Tabs
        Expanded(
          flex: 4,
          child: CustomScrollView(
            slivers: [
        ...
        child: Semantics(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Buscar por nombre, documento o tel├®fono...',
