...
CREATE OR REPLACE VIEW "public"."partner_credit_summary" AS
...
CREATE TABLE IF NOT EXISTS "public"."product_reviews" (
    ...
    "product_id" "uuid" NOT NULL,
    "profile_id" "uuid",
    "user_name" "text" DEFAULT 'Usuario An├│nimo'::"text" NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."user_addresses" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "department" "text" DEFAULT 'Ancash'::"text" NOT NULL,
    "province" "text" DEFAULT 'Santa'::"text" NOT NULL
);
...
ALTER TABLE ONLY "public"."user_addresses"
    ADD CONSTRAINT "user_addresses_profile_id_fkey" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("id");
...
CREATE POLICY "Acceso propio CRUD" ON "public"."user_addresses" USING ((("profile_id" = "public"."auth_profile_id"()) OR ("public"."auth_user_role"() = ANY (ARRAY['admin'::"public"."user_role", 'employee'::"public"."user_role"]))));
...
CREATE POLICY "Actualizaci├│n del propio perfil" ON "public"."profiles" FOR UPDATE USING (("auth_user_id" = "auth"."uid"())) WITH CHECK (("auth_user_id" = "auth"."uid"()));
...
CREATE POLICY "Lectura del propio perfil" ON "public"."profiles" FOR SELECT USING (("auth_user_id" = "auth"."uid"()));



CREATE POLICY "Lectura propia" ON "public"."customer_credits" FOR SELECT USING ((("profile_id" = "public"."auth_profile_id"()) OR ("public"."auth_user_role"() = ANY (ARRAY['admin'::"public"."user_role", 'employee'::"public"."user_role"]))));
...
CREATE POLICY "Modificacion admin" ON "public"."customer_credits" USING (("public"."auth_user_role"() = ANY (ARRAY['admin'::"public"."user_role", 'employee'::"public"."user_role"])));
