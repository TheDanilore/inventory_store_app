...
///
/// Modos:
/// - [isPickerMode] = false ÔåÆ muestra ubicaciones existentes (solo vista)
/// - [isPickerMode] = true  ÔåÆ mueve el mapa para elegir coordenadas;
...
class _CustomerLocationMapScreenState extends State<CustomerLocationMapScreen> {
  ...
  // Throttle: actualizar coordenadas m├íximo una vez cada 200ms
  ...
  LatLng get _initialCenter {
    ...
    return const LatLng(-9.0853, -78.5783); // Default: Chimbote, Per├║
  }
  ...
  // ÔöÇÔöÇ Handlers ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ

  /// Escucha eventos espec├¡ficos del mapa (solo fin de movimiento).
  /// Mucho m├ís eficiente que onPositionChanged (que dispara 60 veces/seg).
  ...
  void _confirmPickerPoint() {
    // Leer la posici├│n actual del mapa en el momento de confirmar (m├ís preciso)
    final currentCenter = _mapController.camera.center;
    Navigator.of(context).pop(currentCenter);
  }

  // ÔöÇÔöÇ Build ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // ÔöÇÔöÇ Mapa ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
          FlutterMap(
            mapController: _mapController,
            options: MapOptions(
              initialCenter: _initialCenter,
              initialZoom: _initialZoom,
              // Rango seguro para OSM p├║blico ÔÇö evita tiles 404 que crashean CanvasKit
              minZoom: 9.0,
              maxZoom: 17.0,
            ...
            children: [
              TileLayer(
                ...
                // keepBuffer bajo: menos tiles en memoria ÔåÆ menos crash en Web
                keepBuffer: 1,
          ...
          // ÔöÇÔöÇ Pin central fijo (Modo Uber) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
          if (widget.isPickerMode)
            const Align(
          ...
          // ÔöÇÔöÇ Header Flotante (Reemplaza el AppBar) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
          Positioned(
          ...
          // ÔöÇÔöÇ Panel de Coordenadas Glassmorphism ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
          if (widget.isPickerMode)
            Positioned(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ValueListenableBuilder<LatLng>(
                              ...
                              builder:
                                  (_, point, _) => Text(
                                    'Lat: ${point.latitude.toStringAsFixed(5)}  ÔÇó  Lng: ${point.longitude.toStringAsFixed(5)}',
                                    style: const TextStyle(
                                      color: AppColors.textPrimary,
                                      fontSize: 13,
                                      fontWeight: FontWeight.w700,
          ...
          // ÔöÇÔöÇ Cr├®ditos OSM (obligatorio por licencia) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
          Positioned(
            bottom: 4,
            right: 8,
            child: IgnorePointer(
